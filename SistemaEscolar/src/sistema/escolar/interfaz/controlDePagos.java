...
public class controlDePagos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lstPagos = new javax.swing.JList();
        ...
        lstPagos.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(lstPagos);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        List<PagosAlumno> pagos;
        if(!"".equals(cmbAlumno.getSelectedItem().toString())){
            Conexion con = new Conexion();
            pagos = con.buscarPagosDeAlumno(cmbAlumno.getSelectedItem().toString());
            for(int i = 0; i < pagos.size(); i++){
                modelo.addElement(pagos.get(i).getPago().getNombre() + ": " + pagos.get(i).getDetalle());
            }
            lstPagos.setModel(modelo);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(controlDePagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new controlDePagos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList lstPagos;
